...
public class ZooMain {
    ...
    public static void main(String[] args) {
        ...
        //
        // //instance of tn.esprit.zooManagement.entities.Zoo used to store the
        // comparison result
        ...
        // ze.displayZoo();
        //
        // //instruction 8 and 9 du prosit 2 (commented for better visibility ,
        // uncomment if needed)
        // // System.out.println("Name : "+ze.name+ ", City : "+ze.city+", Cage number :
        // "+ ze.nbrCages);
        // //System.out.println("Family : "+animal1.family+ ", Name : "+animal1.name+",
        // age : "+ animal1.age+", Mammal : "+animal1.isMammal);
        ...
        //
        // //this is added to verify if the unique animal condition is working
        // (instruction 12)
